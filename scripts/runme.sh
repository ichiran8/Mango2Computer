...
HD_PWD='C:/Users/vanya/Desktop/NewMango2/Mango2Computer/mango2_test/mango2_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log apple2_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source apple2_top.tcl -notrace
